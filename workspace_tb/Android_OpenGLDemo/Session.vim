...
set modelines=0
set mouse=a
set path=.,/usr/include,,,res/layout,res/layout-finger,res/values,res/drawable,res/drawable-mdpi,/System/Library/Frameworks/OpenGL.framework/Headers,~/program/android-ndk-r8c/platforms/android-9/arch-arm/usr/include,jni
set ruler
...
set shortmess=aoO
badd +1 ~/workspace_tb/Android_OpenGLDemo/jni/render.c
args ~/workspace_tb/Android_OpenGLDemo/gen/opengl/demo/BuildConfig.java ~/workspace_tb/Android_OpenGLDemo/gen/opengl/demo/R.java ~/workspace_tb/Android_OpenGLDemo/src/opengl/demo/MainActivity.java ~/workspace_tb/Android_OpenGLDemo/src/opengl/demo/MyRenderer.java
edit ~/workspace_tb/Android_OpenGLDemo/jni/render.c
...
setlocal tabstop=8
setlocal tags=~/.git/c.tags,~/.git/tags,./tags,tags
